...
const matchup = R.converge(R.xprod, [R.map(calcPlayerAContext), R.map(calcPlayerBContext)])(rolls)
...
const percent = R.pipe(R.divide(result["true"]),R.multiply(100),num => Math.round(num))(matchupLength)
